...
public class TAlquiler{
    public static final String EXTRA_FECHA_PAGO = "extra_fecha_pago";
    ...
    public static final String PAGOS_REALIZADOS = "pagos_realizados";
    ...
    public static final int INT_PAGOS_REALIZADOS = 2;
    ...
    public static final int INT_ALERT = 8;
