...
public class VerCuartoActivity {
...
/*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.iAgregarInquilino: {
                ...
                Intent i = new Intent(this, RegistroUsuarioView.class);
    ...
    @Override
    public void onClickPagarAlquiler(View view) {
    ...
    protected void iniciarViews() {
      ...
      //  tvNumeroCuarto = findViewById(R.id.tvNumeroCuarto);
        ...
        btPagarAlquiler = findViewById(R.id.positiveButton);
